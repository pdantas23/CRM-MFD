...
paths:
  /pedidos/{id_ped}/parcelas:
    get:
      ...
      deprecated: false
      description: Request para a consulta das parcelas de um pedido.
      tags:
        - Vendas/Pedidos
      parameters:
        - name: id_ped
              ...
              example:
                ...
                data:
                  - id_parcela: 123456
                    ...
                    observacoes_parcela: Observações
                  - id_parcela: 123456
                    id_pedido: 123456
                    data_parcela: '0000-00-00'
                    valor_parcela: '100.00'
          ...
          content:
            application/json:
              ...
              example:
                code: 403
                status: error
                data: Nenhuma parcela para o pedido encontrado!
          headers: {}
          x-apidog-name: Proibido
      security: []
      x-apidog-folder: Vendas/Pedidos
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/876772/apis/api-16434156-run
components:
  schemas: {}
  securitySchemes: {}
servers: []
