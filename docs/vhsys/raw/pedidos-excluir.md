...
paths:
  /pedidos/{id_ped}:
    delete:
      ...
      deprecated: false
      description: >-
        Request para excluir um pedido, o pedido excluído pode ser encontrado
        com o método GET passando o parâmetro lixeira=Sim.
      tags:
        - Vendas/Pedidos
      parameters:
        - name: id_ped
          ...
          content:
            application/json:
              ...
              example:
                code: 403
                status: error
                data: Erro ao deletar o pedido!
          headers: {}
          x-apidog-name: Proibido
      security: []
      x-apidog-folder: Vendas/Pedidos
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/876772/apis/api-16424444-run
components:
  schemas: {}
  securitySchemes: {}
servers: []
