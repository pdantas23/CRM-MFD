...
paths:
  /orcamentos/{id_orcamento}:
    delete:
      ...
      deprecated: false
      description: >-
        Request para excluir um orçamento, o orçamento excluído pode ser
        encontrada com o método GET passando o parâmetro lixeira=Sim.
      tags:
        - Vendas/Orçamentos
      parameters:
        - name: id_orcamento
          ...
          content:
            application/json:
              ...
              example:
                code: 403
                status: error
                data: Erro ao deletar o orçamento!
          headers: {}
          x-apidog-name: Proibido
      security: []
      x-apidog-folder: Vendas/Orçamentos
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/876772/apis/api-16285170-run
components:
  schemas: {}
  securitySchemes: {}
servers: []
