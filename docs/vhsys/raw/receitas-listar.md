  ...
  /contas-receber:
    get:
      ...
      parameters:
        ...
        - name: valor_receita
          in: query
          description: Valor da receita buscar
          required: false
          schema:
            type: string
            examples:
              - >-
                A partir de um valor: valor_receita=10.00 buscar entre valores:
                valor_receita=10.00,20.00
        - name: valor_pago
          in: query
          description: |-
            Valor pago:
            buscar a partir de um valor: valor_pago=10.00
            buscar entre valores: valor_pago=10.00,20.00
          required: false
          schema:
            type: string
        - name: data_pagamento
        ...
        - name: liquidado
          in: query
          description: Se a conta está liquidada
          required: false
          schema:
            type: string
            enum:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/876772/apis/api-16174385-run
components:
  schemas: {}
  securitySchemes: {}
servers: []
