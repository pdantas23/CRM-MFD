...
const statusConfig: Record<StatusEntrega, { label: string; labelCurto: string; class: string }> = {
  ...
  entrega_parcial: { label: "Entrega Parcial", labelCurto: "Parcial", class: "bg-primary-100 text-primary-800 border-primary-200" },
};
...
export const statusRowClass: Record<StatusEntrega, string> = {
  ...
  entrega_parcial: "bg-primary-50 hover:bg-primary-100 border-l-4 border-primary-400",
};
