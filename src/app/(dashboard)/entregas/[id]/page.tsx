        ...
        {e.anexo_url && (
          <div className="card p-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-primary-600 transition-colors hover:bg-gray-100 hover:text-primary-700"
            >
